    ...
    public function up(): void
    {
        Schema::create('pendaftaran_event', function (Blueprint $table) {
            ...
            $table->foreignId('event_id')->constrained('event_pengembangan_karir')->onDelete('cascade')
                  ->index('fk_pendaftaran_event_event_pengembangan_karir_index'); // Berikan nama unik pada foreign key constraint
            $table->foreignId('user_id')->constrained('users')->onDelete('cascade')
                  ->index('fk_pendaftaran_event_users_index'); // Berikan nama unik pada foreign key constraint
