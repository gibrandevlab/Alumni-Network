...
<div class="container py-8 min-h-screen">
    <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="md:col-span-2">
            ...
            <img src="{{ ($workshop->foto && file_exists(public_path('images/events/' . $workshop->foto))) ? asset('images/events/' . $workshop->foto) : 'https://via.placeholder.com/600x300' }}" class="w-full h-64 object-cover rounded-xl mb-6" alt="Event Image">
