    ...
    <div class="rounded-t mb-0 px-0 border-0">
        <div class="flex flex-wrap items-center px-4 py-2">
            <div class="relative w-full max-w-full flex-grow flex-1">
                <h3 class="font-semibold text-base text-white">Status Karir Alumni (Seluruh Tahun)</h3>
            </div>
            <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                <div class="flex items-center space-x-4">
                    <select name="jurusan2" class="bg-gray-700 text-white rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
...
<script>
    ...
    // Gunakan parameter jurusan2 agar konsisten dengan select name
    var jurusanFilter = '{{ request('jurusan2') }}';
    var filteredData = [];
