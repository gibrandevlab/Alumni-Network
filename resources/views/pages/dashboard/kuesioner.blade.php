...
<div class="min-h-screen bg-gray-100 py-8 px-2">
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <a href="{{ route('dashboard.kuesioner.create') }}" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-2 rounded-lg shadow transition">+ Tambah Kuesioner</a>
        </div>
